import argparse
from model_sp_5_helpers import calculate_randomFieldE, sp_5_sobol_run_samples_and_save_2
...
def main():
    ...
    while True:
        sp_5_sobol_run_samples_and_save_2(mc_sample_size=args.mc_samples,
